...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C8() {
      return C[8] = dart.constList([C[9] || CT.C9, C[10] || CT.C10], fluttertoast.Toast);
    },
    get C12() {
    ...
    get C11() {
      return C[11] = dart.constList([C[12] || CT.C12, C[13] || CT.C13, C[14] || CT.C14, C[15] || CT.C15, C[16] || CT.C16, C[17] || CT.C17, C[18] || CT.C18, C[19] || CT.C19, C[20] || CT.C20, C[21] || CT.C21, C[22] || CT.C22], fluttertoast.ToastGravity);
    },
    get C23() {
  ...
  userlist._UserListState = class _UserListState extends framework.State$(userlist.UserList) {
    build(context) {
      return new app.MaterialApp.new({home: new scaffold.Scaffold.new({body: new basic.Column.new({children: T.JSArrayOfWidget().of([new container.Container.new({child: new basic.Padding.new({padding: C[1] || CT.C1, child: new text_field.TextField.new({controller: this.nama, decoration: new input_decorator.InputDecoration.new({labelText: "Nama", border: new input_border.OutlineInputBorder.new()})})})}), new container.Container.new({child: new basic.Padding.new({padding: C[1] || CT.C1, child: new text_field.TextField.new({controller: this.umur, decoration: new input_decorator.InputDecoration.new({labelText: "Umur", border: new input_border.OutlineInputBorder.new()})})})}), new container.Container.new({child: new basic.Padding.new({padding: C[1] || CT.C1, child: new text_field.TextField.new({controller: this.email, decoration: new input_decorator.InputDecoration.new({labelText: "Email", border: new input_border.OutlineInputBorder.new()})})})}), new container.Container.new({padding: new edge_insets.EdgeInsets.all(5), child: new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => {
                    try {
                      if (this.nama.text[$isEmpty] || this.umur.text[$isEmpty] || this.email.text[$isEmpty]) {
                        dart.throw(core.Exception.new("Isian Tidak Boleh Kosong"));
                      }
                      if (this.btnSimpanText === "Simpan") {
                        for (let i = 0; i < core.int.parse(this.umur.text); i = i + 1) {
                          this.daftarUser[$add](new userdata.UserData.new(dart.str(i + 1) + ". " + this.nama.text, core.int.parse(this.umur.text), this.email.text));
                        }
                      } else {
                      ...
                      if (core.Object.is(e)) {
                        ...
                        throw e$;
                  ...
                  }, T.VoidTovoid()), child: new text.Text.new(this.btnSimpanText), style: elevated_button.ElevatedButton.styleFrom({minimumSize: new ui.Size.new(150, 75), backgroundColor: this.btnSimpanWarna})})}), new basic.Expanded.new({child: new single_child_scroll_view.SingleChildScrollView.new({child: new scroll_view.ListView.separated({scrollDirection: basic_types.Axis.vertical, shrinkWrap: true, itemBuilder: dart.fn((context, index) => new dismissible.Dismissible.new({key: new (T.ValueKeyOfString()).new(this.daftarUser[$toString]()), child: new ink_well.InkWell.new({child: new useritem.UserItem.new(this.daftarUser[$_get](index)), onTap: dart.fn(() => {
                          ...
                          this.btnSimpanWarna = this.btnUbahWarna;
                          this.indexDipilih = index;
                          this.setState(dart.fn(() => {
                            this.btnSimpanText;
                            this.btnSimpanWarna;
                          }, T.VoidTovoid()));
                        ...
                        return yield dialog.showDialog(core.bool, {context: context, builder: dart.fn(context => new dialog.AlertDialog.new({title: C[2] || CT.C2, content: C[3] || CT.C3, actions: T.JSArrayOfWidget().of([new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => navigator.Navigator.of(context).pop(core.bool, true), T.VoidTovoid()), child: C[4] || CT.C4}), new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => navigator.Navigator.of(context).pop(core.bool, false), T.VoidTovoid()), child: C[5] || CT.C5})])}), T.BuildContextToAlertDialog())});
  ...
  (userlist._UserListState.new = function() {
    ...
    this.daftarUser = T.JSArrayOfUserData().of([new userdata.UserData.new("Selvia", 21, "selvia@gmail.com"), new userdata.UserData.new("Deny", 23, "deny@gmail.com"), new userdata.UserData.new("Keysha", 4, "keysha@gmail.com")]);
    this.btnSimpanText = "Simpan";
    this.btnUbahText = "Ubah";
    this.btnSimpanWarna = colors.Colors.blue;
    this.btnUbahWarna = colors.Colors.blueGrey;
    this.indexDipilih = 0;
  ...
  dart.setFieldSignature(userlist._UserListState, () => ({
    ...
    btnUbahWarna: dart.fieldType(ui.Color),
  ...
  fluttertoast_web.FluttertoastWebPlugin = class FluttertoastWebPlugin extends core.Object {
    ...
    static registerWith(registrar) {
      let channel = new platform_channel.MethodChannel.new("PonnamKarthik/fluttertoast", C[6] || CT.C6, registrar);
  ...
  fluttertoast.FToast = class FToast extends core.Object {
    ...
    showToast(opts) {
      ...
      let toastDuration = opts && 'toastDuration' in opts ? opts.toastDuration : C[24] || CT.C24;
      let gravity = opts && 'gravity' in opts ? opts.gravity : null;
      let fadeDuration = opts && 'fadeDuration' in opts ? opts.fadeDuration : C[25] || CT.C25;
