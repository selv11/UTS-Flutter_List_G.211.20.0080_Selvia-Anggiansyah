...
class _UserListState extends State<UserList> {
  ...
  List<UserData> daftarUser = [
    UserData("Selvia", 21, "selvia@gmail.com"),
    UserData("Deny", 23, "deny@gmail.com"),
    UserData("Keysha", 4, "keysha@gmail.com"),
  ];
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    minimumSize: Size(150, 75), backgroundColor: btnSimpanWarna),
              ),
            ),
            Expanded(
                        ...
                        return await showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: const Text("Apakah yakin akan menghapus"),
                              actions: [
                                ElevatedButton(
                                  onPressed: () =>
